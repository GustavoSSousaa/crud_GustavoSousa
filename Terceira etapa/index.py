...
#jan.iconbitmap(default="C:/Users/gustavo_s_sousa/Documents/icons/2 (1).jpg") # Define o ícone da janela

# CARREGAR IMAGEM
logo = PhotoImage(file="icon/2.png") # Carrega a imagem do logo
